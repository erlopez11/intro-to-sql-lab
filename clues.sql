...
-- Write SQL query here
SELECT countrycode from countrylanguages WHERE language = 'Italian' AND isofficial = TRUE;
SELECT name FROM countries WHERE code = 'CHE';
SELECT name FROM countries WHERE code = 'ITA';
SELECT name FROM countries WHERE code = 'SMR';
SELECT name FROM countries WHERE code = 'VAT';
